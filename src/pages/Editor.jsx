...
const TextEditor = () => { 
  ...
  // List of vendors with their email addresses 
  const vendors = [ 
  ...
  const handleSendDocument = async () => { 
    ...
    const documentData = { 
      content: value, 
      recipientEmail: selectedVendor, // email of the selected vendor 
    }; 
    ...
    <div className="h-screen w-full flex flex-col"> 
      ...
      <div className="w-full flex flex-col items-center mb-4"> 
        ...
        > 
          ...
          {vendors.map((vendor) => ( 
            <option key={vendor.name} value={vendor.email}> 
              {vendor.name} 
            </option> 
          ))} 
        </select> 
